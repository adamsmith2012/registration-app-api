...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { first_name: @instructor.first_name, last_name: @instructor.last_name } }, as: :json
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { first_name: @instructor.first_name, last_name: @instructor.last_name } }, as: :json
    assert_response 200
  end
