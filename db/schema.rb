...
ActiveRecord::Schema.define(version: 20170601203409) do
  ...
  create_table "schedules", force: :cascade do |t|
    ...
    t.index ["student_id", "course_id"], name: "index_schedules_on_student_id_and_course_id", unique: true, using: :btree
